...
class TechnicianJobCardScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TechnicianJobCardScreen> createState() =>
      _TechnicianJobCardScreenState();
}

class _TechnicianJobCardScreenState
    extends ConsumerState<TechnicianJobCardScreen> {
  ...
  void initState() {
    ...
    _modelController =
        TextEditingController(text: activeJob?.vehicleModel ?? '');
    _plateController =
        TextEditingController(text: activeJob?.vehiclePlate ?? '');
  }
  ...
  Widget build(BuildContext context) {
    ...
    final completedTasks =
        activeJob.checklist.where((item) => item.isDone).length;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('${activeJob.id} Execution',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_isEditing)
                            ...
                            Text('${activeJob.vehiclePlate} • Petrol',
                                style: const TextStyle(
                                    fontSize: 12, color: Colors.white70)),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: entry.value.map((item) {
                          final originalIndex =
                              activeJob.checklist.indexOf(item);
