    ...
    return Scaffold(
      ...
      body: ref.watch(rentalCatalogProvider).when(
        data: (fleet) {
          ...
          if (vehicles.isEmpty) return const Center(child: Text('No vehicles found for this filter'));
          ...
          boxShadow: [
            BoxShadow(
              color: isZeelio 
                  ...
                  : (isEV ? Colors.green.withValues(alpha: 0.12) : Colors.black.withValues(alpha: 0.08)),
              blurRadius: 24,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: vehicle['isComingSoon'] == true ? null : [BoxShadow(color: Colors.black.withValues(alpha: 0.1), blurRadius: 10)],
                    ),
                    child: Text(
                      vehicle['is_coming_soon'] == true ? 'N/A' : vehicle['price'],
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w900,
