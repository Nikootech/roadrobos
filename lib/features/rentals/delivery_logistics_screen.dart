...
class DeliveryLogisticsScreen extends ConsumerWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildStatusStep('$vehicleName Prepared',
                'Your vehicle has been sanitized and checked.', true, true),
            _buildStatusStep('Delivery in Progress',
                'Our pilot is on the way to your location.', true, false),
            _buildStatusStep('Verification', 'E-KYC and signature on arrival.',
                false, false),
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                      ...
                      onPressed: () async {
                        final Uri url =
                            Uri(scheme: 'tel', path: '+18005550199');
  ...
  Widget _buildStatusStep(
      String title, String desc, bool isDone, bool isFirst) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(
