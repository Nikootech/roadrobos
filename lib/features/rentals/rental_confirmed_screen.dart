            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      'Your rental booking for $vehicleName is successful. You can track your vehicle status in "My Bookings".',
                  ...
                  OutlinedButton.icon(
                    onPressed: () async {
                      ...
                      final basePrice = double.tryParse(basePriceStr.replaceAll(
                              RegExp(r'[^0-9.]'), '')) ??
                          0.0;
