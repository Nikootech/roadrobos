...
class _RateRideScreenState extends State<RateRideScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildRatingButton(true, 'Great', Icons.thumb_up_rounded, Colors.green),
                const SizedBox(width: 32),
                _buildRatingButton(false, 'Bad', Icons.thumb_down_rounded, Colors.red),
              ],
            ),
            ...
            if (_isPositive != null) ...[
               const Align(
                 ...
                 child: Text('Add a note', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
               ),
            ...
            ElevatedButton(
              ...
              child: const Text('Submit Feedback', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
            ),
          ],
        ),
      ),
  ...
  Widget _buildRatingButton(bool positive, String label, IconData icon, Color color) {
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon, color: isSelected ? color : Colors.grey, size: 32),
          ),
