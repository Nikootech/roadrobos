            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                      ...
                      return GestureDetector(
                        ...
                        child: Icon(
                          ...
                          size: 50,
                            ...
                            .animate(target: index < _selectedRating ? 1 : 0)
                            .scale(
                  ...
                  CustomButton(
                    label: taxiState.paymentMethod == 'Online'
                        ? 'PAY ₹${(fare + taxiState.tipAmount).toStringAsFixed(0)} & FINISH'
                        : 'DONE',
                    onPressed: () async {
                      if (taxiState.paymentMethod == 'Online') {
                        ...
                        final userEmail =
                            authState.user?.email ?? 'user@roadrobos.com';
                      ...
                      if (rideId != null &&
                        ...
                        try {
                          await Supabase.instance.client
                              .from('ride_bookings')
                              .update({'customer_rating': _selectedRating}).eq(
                                  'id', rideId);
                        } catch (e) {
