      ...
      body: ListView(
        ...
        children: [
          const Padding(
            ...
            child: Text('SELECT PREFERRED LANGUAGE', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: AppColors.textSecondary, letterSpacing: 1.2)),
          ),
          ...['English', 'Hindi (हिन्दी)', 'Telugu (తెలుగు)', 'Marathi (मराठी)', 'Tamil (தமிழ்)', 'Kannada (ಕನ್ನಡ)'].map((l) {
            ...
            return Container(
              ...
              child: ListTile(
                ...
                trailing: isSelected 
                  ? const Icon(Icons.check_circle_rounded, color: AppColors.primaryBlue, size: 22).animate().scale() 
                  : Container(width: 22, height: 22, decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: AppColors.border, width: 2))),
              ),
