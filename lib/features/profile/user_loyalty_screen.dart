  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('RoAdRoBos Platinum',
            style: TextStyle(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text('Platinum Tier',
                        style: TextStyle(
                            color: Colors.white,
            ...
            _buildRewardTile(
                '₹500 Fuel Coupon', '4,500 Pts', Iconsax.gas_station),
            ...
            const SizedBox(height: 16),
            const Text(
                'Earn 1 point for every ₹1 spent on rides, rentals, or services.',
