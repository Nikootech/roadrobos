...
class AdminCustomer {
  ...
  AdminCustomer(this.id, this.name, this.joinDate, this.ltv, this.rides,
      this.rentals, this.services, this.activities);
}
              ...
              data: (customers) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return _buildCustomerCard(filtered[index])
                        .animate()
                  ...
                  children: [
                    Text('${c.name} (${c.id})',
                        style: GoogleFonts.outfit(
                            ...
                            fontWeight: FontWeight.w700,
                            color: AppColors.textPrimary)),
                    Text('Joined: ${c.joinDate} • LTV: ₹${c.ltv.toInt()}',
          ...
          subtitle: Padding(
            ...
            child: Row(
              children: [
                ...
                _buildBadge(
                    '🚗', '${c.rentals} Rentals', AppColors.successGreen),
                const SizedBox(width: 8),
                _buildBadge(
                    '🔧', '${c.services} Services', AppColors.warningAmber),
              ],
            ),
          ),
          childrenPadding:
