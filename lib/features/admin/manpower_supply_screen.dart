...
class ManpowerSupplyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Manpower Allocation',
            style: TextStyle(
        ...
        child: Column(
          children: [
            ...
            _buildAllocationCard(
                'Hyderabad Central', '12 Active', '4 On Leave', 0.75),
            const SizedBox(height: 12),
            _buildAllocationCard(
                'Bangalore East', '18 Active', '2 On Leave', 0.90),
            const SizedBox(height: 12),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                      child: Text(
                          'Delhi Hub reports 40% manpower shortage for tomorrow\'s morning shift.',
                          style: TextStyle(
                              fontSize: 12,
  ...
  Widget _buildAllocationCard(
      String hub, String active, String leave, double progress) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
          color: Colors.white,
