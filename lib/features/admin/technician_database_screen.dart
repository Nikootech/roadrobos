...
class AdminTechnician {
  ...
  AdminTechnician(this.id, this.uid, this.name, this.joinDate, this.booked,
      this.undergoing, this.completed, this.jobs);
}
              ...
              data: (techs) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return _buildTechCard(context, ref, filtered[index])
                        .animate()
      ...
      if (context.mounted) {
        unawaited(showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
                'All service bookings are currently assigned to technicians.'),
            actions: [
              TextButton(
          ...
          content: SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final packageName =
                    booking['package_name'] ?? 'General Service';
          ...
          subtitle: Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                _buildBadge(
                    '⚙️', '${t.undergoing} In Progress', AppColors.primaryBlue),
                _buildBadge(
                    '✅', '${t.completed} Completed', AppColors.successGreen),
              ],
            ),
          ),
          childrenPadding:
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Assign Booking',
                      style: TextStyle(
                          fontSize: 11,
                          color: Colors.white,
                          fontWeight: FontWeight.bold)),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('${job.regNo} - ${job.vehicleType}',
                                  style: const TextStyle(
                                      fontWeight: FontWeight.w600,
                                      fontSize: 13,
                                      color: AppColors.textPrimary)),
                              Text('Status: ${job.status} • ${job.date}',
                                  style: const TextStyle(
                                      fontSize: 11,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                  content: Text(
                                      'Downloading Invoice for ₹${job.invoice.toInt()}...')));
                            },
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text(
                                          'Viewing Detailed Service Report...')));
                            },
                            tooltip: 'View Report',
                          )
                        ] else
