  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Manage Reminders', style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildReminderCard('Service Due Reminder', 'Target: Bajaj Pulsar Owners', 'Scheduled: Oct 20, 10:00 AM', true),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(target, style: const TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                const SizedBox(height: 6),
                Text(meta, style: TextStyle(color: isUpcoming ? AppColors.primaryBlue : AppColors.textMuted, fontSize: 10, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
          if(isUpcoming) const Icon(Iconsax.edit, size: 18, color: AppColors.textSecondary),
        ],
      ),
