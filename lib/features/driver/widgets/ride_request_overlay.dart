  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: Dismissible(
        ...
        background: _buildActionBg(AppColors.successGreen, Icons.check_circle_rounded, 'ACCEPT', true),
        secondaryBackground: _buildActionBg(AppColors.dangerRed, Icons.close_rounded, 'REJECT', false),
        child: Container(
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text('₹${widget.request.fare.toInt()}', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: AppColors.successGreen, letterSpacing: -1)),
                              Text(widget.request.distance, style: const TextStyle(color: AppColors.textSecondary, fontWeight: FontWeight.w700, fontSize: 13)),
                            ],
                          )
                        ],
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _buildCompactLocation(Icons.radio_button_checked_rounded, AppColors.primaryBlue, widget.request.pickup),
                      ...
                      const Row(
                        ...
                        children: [
                          Icon(Icons.swipe_right_rounded, size: 16, color: AppColors.textMuted),
                          SizedBox(width: 8),
                          Text('Swipe to Accept or Reject', style: TextStyle(color: AppColors.textMuted, fontSize: 13, fontWeight: FontWeight.w600)),
                          SizedBox(width: 8),
                          Icon(Icons.swipe_left_rounded, size: 16, color: AppColors.textMuted),
                        ],
                      )
                    ],
                  ),
                  ...
                  builder: (context, child) {
                    return LinearProgressIndicator(
                      ...
                      valueColor: AlwaysStoppedAnimation<Color>(
                        _timerController.value > 0.8 ? AppColors.dangerRed : AppColors.primaryBlue
                      ),
                      minHeight: 2,
                    );
                  },
      ...
      ).animate().scale(begin: const Offset(0.9, 0.9), curve: Curves.easeOutBack, duration: 600.ms).fadeIn(),
    );
  }

  Widget _buildActionBg(Color color, IconData icon, String label, bool isStart) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(label, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 1.2)),
        ],
      ),
    );
  }
  ...
  Widget _buildCompactLocation(IconData icon, Color color, String address) {
    return Row(
      children: [
        ...
        const SizedBox(width: 12),
        Expanded(child: Text(address, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: AppColors.textPrimary), maxLines: 1, overflow: TextOverflow.ellipsis)),
      ],
    );
  }
}
