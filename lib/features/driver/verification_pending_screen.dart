...
class _VerificationPendingScreenState
  ...
  void initState() {
    ...
    ref.listen<AsyncValue<VerificationStatus>>(verificationProvider,
        (previous, next) {
        ...
        data: (status) => RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(
                              ...
                              size: 44,
                              color: status == VerificationStatus.rejected
                                  ? AppColors.dangerRed
              ...
              const SizedBox(height: 20),
              _buildPremiumStatusCard('Driving License', 'In Review',
                  Iconsax.document_text, AppColors.primaryBlue),
              _buildPremiumStatusCard('Vehicle Registration', 'Approved',
                  Iconsax.tick_circle, AppColors.successGreen),
              ...
              _buildPremiumStatusCard('Profile Photo', 'Approved', Iconsax.user,
                  AppColors.successGreen),
              const SizedBox(height: 48),
              Container(
                padding:
                ...
                child: Column(
                  children: [
                    const Text('ESTIMATED VERIFICATION TIME',
                        style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.w900,
                            color: AppColors.textSecondary,
              ...
              if (status == VerificationStatus.rejected)
                CustomButton(
                    ...
                    onPressed: () => ref
                        ...
                        .updateStatus(DriverApprovalStatus.pending),
