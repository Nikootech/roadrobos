...
class _InsuranceSelectionScreenState
  ...
  void _handleBuyInsurance(Vehicle vehicle) async {
    ...
    if (mounted) {
      ...
      _showSuccessDialog(
          'Your vehicle (${vehicle.name}) is now covered under the $package policy!');
    }
  }

  void _handleLinkPolicy(Vehicle vehicle) async {
    if (_policyNoController.text.trim().isEmpty ||
    ...
    if (mounted) {
      ...
      _showSuccessDialog(
          'Successfully linked existing policy #$policyNo to your vehicle (${vehicle.name})!');
    }
  }
          ...
          child: Column(
            ...
            children: [
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                            color: borderCol, width: isSelected ? 2.0 : 1.0),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.check_rounded,
                                        size: 14, color: pkg['color'] as Color),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed:
                      _isBuying ? null : () => _handleBuyInsurance(vehicle),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.primaryBlue,
